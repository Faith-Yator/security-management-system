...
import './Card.css';
import { RiShieldKeyholeLine, RiHomeGearLine, RiBuilding2Line } from 'react-icons/ri'; 
...
const Card = ({ icon, title, description }) => {
  ...
  return (
    ...
    >
      ...
      <h2><RiShieldKeyholeLine />Personal security</h2>
   ...
   >
     ...
     <h2> <RiHomeGearLine/> Home security</h2>
   ...
   <div
    ...
    >
      ...
      <h2> <RiBuilding2Line/>Enterprise security</h2>
      {isHovered && <p>
